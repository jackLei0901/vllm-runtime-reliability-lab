"""Per-rank Gate 1d probe for accumulated unused-gradient failure."""
...
def authorize_observer_from_env() -> str:
    """Authorize py-spy under Yama, or explicitly record that Yama is absent."""
...
def main() -> int:
    ...
    emit("DFX_RANK_PTRACE=", {"rank": rank, "mode": ptrace_mode})
