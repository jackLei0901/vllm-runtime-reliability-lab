...
replay users, and one external contributor or issue reporter. Stars measure
reach; verified runs and useful feedback measure whether the lab is usable.
...
| Days 1–3 | Send the replay to 5–8 relevant engineers individually or in one focused vLLM channel | completed runs and concrete questions |
